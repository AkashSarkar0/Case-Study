...
class Book extends Component
{
    ...
    render() 
    {
        const {bookingId,name,gender,contactNo,journeyDate,address,train_id,noOfAdults,noOfMinors,seatType,paymentStatus}=this.state
        return (
          <div className='ui_main_book'>
             <h1 className="book_title">Book Train</h1>
             <div>
                <a href="/cancelbooking">
                  <button className='cancelbookbtn' id="cancelbookingbtn">Cancel Booking</button>
                </a>
              </div>
